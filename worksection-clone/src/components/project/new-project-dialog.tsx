      ...
      <DialogContent>
        ...
        <form action={onSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            <Input id="name" name="name" placeholder="Например, Мобильное приложение" autoFocus />
          </div>
          <div className="space-y-2">
            <Label htmlFor="description">Описание</Label>
            <Textarea id="description" name="description" placeholder="Коротко о проекте" rows={3} />
          </div>
          <div className="space-y-2">
            <Label>Цвет</Label>
