        ...
        <div className="relative" style={{ width: chartW }}>
          ...
          <div className="relative" style={{ height: chartH }}>
            ...
            {todayX >= 0 && todayX <= chartW && (
              <div className="absolute top-0 z-20 w-px bg-red-500/70" style={{ left: todayX, height: chartH }}>
                <span className="absolute -top-0 left-1 text-[9px] font-medium text-red-500">сегодня</span>
              </div>
            )}
            ...
            {milestones.map((m) => {
              ...
              return (
                <div key={m.id} className="absolute top-0 z-20" style={{ left: x, height: chartH }}>
                  <div className="absolute top-0 w-px bg-violet-400/60" style={{ height: chartH }} />
                  <div
                    className="absolute -top-0 size-2.5 -translate-x-1/2 rotate-45 bg-violet-500"
                    style={{ left: 0 }}
                    title={m.title}
                  />
                </div>
