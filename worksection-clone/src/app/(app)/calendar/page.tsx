  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-8">
      <div className="mb-6 flex flex-wrap items-center gap-4">
        <h1 className="text-2xl font-semibold tracking-tight">{MONTH_NAMES[month]} {year}</h1>
        <div className="flex items-center gap-1">
          ...
          <Link href="/calendar" className="rounded-md border px-2.5 py-1 text-xs hover:bg-muted">Сьогодні</Link>
