    ...
    <>
      ...
      <Group title="Обучение">
        ...
        <p style={{ color: "var(--ink-3)", fontSize: 12, margin: 0, fontWeight: 600 }}>
          Подмешивает в «Сегодня» выученные слова, только когда вероятность их вспомнить реально просела (ниже ~90%) и прошло
          хотя бы несколько дней — выученное вчера сегодня не вернётся. Если ошибёшься — слово теряет статус «выучено» и
          возвращается в обычную очередь.
        </p>
      </Group>
