...
export type NotificationSettingOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"type" | "pushEnabled" | "telegramEnabled", ExtArgs["result"]["notificationSetting"]>
...
export interface NotificationSettingDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const notificationSettingWithTypeOnly = await prisma.notificationSetting.findMany({ select: { type: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many NotificationSettings and only return the `type`
   * const notificationSettingWithTypeOnly = await prisma.notificationSetting.createManyAndReturn({
   *   select: { type: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more NotificationSettings and only return the `type`
   * const notificationSettingWithTypeOnly = await prisma.notificationSetting.updateManyAndReturn({
   *   select: { type: true },
   *   where: {
   *     // ... provide filter here
   *   },
