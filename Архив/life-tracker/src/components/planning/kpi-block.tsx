      ...
      <div className="mt-2 flex items-center gap-2">
        ...
        <button
          ...
          className={cn("rounded-md border px-2.5 py-1 text-xs font-medium transition-colors disabled:opacity-50",
            kpi.achieved === true ? "border-primary bg-accent text-accent-foreground" : "hover:bg-muted")}
        >
          <Check className="mr-1 inline size-3" /> {t(locale, "kpi.achieved")}
        </button>
        <button
          disabled={!canEditResult}
          onClick={() => save(false)}
