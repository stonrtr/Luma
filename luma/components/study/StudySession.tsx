          ...
          <>
            ...
            {usedHint ? (
              ...
              <div className="grade-row" style={{ display: "flex", gap: 12, flexWrap: "wrap", justifyContent: "center" }}>
                ...
                <button className="gbtn grade-btn" style={{ minHeight: 52, padding: "0 26px", fontSize: 16 }} onClick={() => grade("hard")}>
                  <span className="kbd-arrow">↓ </span>С трудом
                </button>
                <button className="wbtn grade-btn" style={{ minHeight: 52, padding: "0 30px", fontSize: 16 }} onClick={() => grade("easy")}>
